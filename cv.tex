...
\fontspec [Path = /Users/ryanbeauchemin/Documents/Fonts/,
...
\setmainfont [Path = /Users/ryanbeauchemin/Documents/Fonts/,
    UprightFont = Fontin-Regular,
    BoldFont = Fontin-Bold,
    ItalicFont = Fontin-Italic,
    SmallCapsFont = Fontin-SmallCaps
...
\newgeometry{vmargin={10mm}, hmargin={10mm,14mm}}   % set the margins
...
%-----------------------------------------------
\textsc{Redbird} & Lead of Data Science\\
\textsc{2025-2026} & \begin{minipage}[t]{\linewidth}
\begin{itemize}[nosep, after=\strut, leftmargin=*]
\footnotesize{
\item As the lead of data science reporting directly to the CEO, I was responsible for a number of data science initiatives for a workflow building platform, including no-code model training, mix media modeling, and agentic generative AI.
\item The work most attractive to our clients was my suite of tools that write, explain, and execute code reliably (< 2\% reported hallucination rate) to generate data science pipelines with minimal coding time. The robustness came from utilizing langgraph and langchain with OpenAI StructuredOutput API to make specialized connected agents.}
\end{itemize}
\end{minipage}\\
\multicolumn{2}{c}{} \\
...
\textsc{2022 - 2025} & \begin{minipage}[t]{\linewidth}
\begin{itemize}[nosep, after=\strut, leftmargin=*]
\footnotesize{
\item As Director, I continued building on our suite of Home page and PDP personalization and also expanded my scope.
...
AI/ML & \hspace{0.25cm} Python, Keras, Tensorflow, Langgraph, Langchain\\
